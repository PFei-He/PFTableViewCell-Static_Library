...
#ifndef	strongify
    #if __has_feature(objc_arc)
        #define strongify(object) try{} @finally{} __typeof__(object) object = __weak_##object##__;
    #else
        #define strongify(object) try{} @finally{} __typeof__(object) object = __block_##object##__;
    #endif
#endif
